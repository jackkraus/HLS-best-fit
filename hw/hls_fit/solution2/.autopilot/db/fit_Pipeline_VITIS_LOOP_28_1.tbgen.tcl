...
set C_modelArgList {
	...
	{ sxx_out int 64 regular {pointer 1}  }
	{ sxy_out int 64 regular {pointer 1}  }
	{ sy_out int 64 regular {pointer 1}  }
	{ sx_out int 64 regular {pointer 1}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 128, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "arrx","offset": { "type": "dynamic","port_name": "arrx","bundle": "control"},"direction": "READONLY"},{"cName": "arry","offset": { "type": "dynamic","port_name": "arry","bundle": "control"},"direction": "READONLY"},{"cName": "arrsigs","offset": { "type": "dynamic","port_name": "arrsigs","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "sxx_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "sxy_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "sy_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ sxx_out sc_out sc_lv 64 signal 6 } 
	{ sxx_out_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ sxy_out sc_out sc_lv 64 signal 7 } 
	{ sxy_out_ap_vld sc_out sc_logic 1 outvld 7 } 
	{ sy_out sc_out sc_lv 64 signal 8 } 
	{ sy_out_ap_vld sc_out sc_logic 1 outvld 8 } 
	{ sx_out sc_out sc_lv 64 signal 9 } 
	{ sx_out_ap_vld sc_out sc_logic 1 outvld 9 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sxx_out", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "sxx_out", "role": "default" }} , 
 	{ "name": "sxx_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "sxx_out", "role": "ap_vld" }} , 
 	{ "name": "sxy_out", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "sxy_out", "role": "default" }} , 
 	{ "name": "sxy_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "sxy_out", "role": "ap_vld" }} , 
 	{ "name": "sy_out", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "sy_out", "role": "default" }} , 
 	{ "name": "sy_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "sy_out", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			...
			{"Name" : "sxx_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "sxy_out", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "sy_out", "Type" : "Vld", "Direction" : "O"},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_64s_64s_64_1_1_U1", "Parent" : "0"},
...
set ArgLastReadFirstWriteLatency {
	fit_Pipeline_VITIS_LOOP_28_1 {
		...
		sxx_out {Type O LastRead -1 FirstWrite 73}
		sxy_out {Type O LastRead -1 FirstWrite 73}
		sy_out {Type O LastRead -1 FirstWrite 73}
		sx_out {Type O LastRead -1 FirstWrite 73}}}
...
set Spec2ImplPortList { 
	...
	sxx_out { ap_vld {  { sxx_out out_data 1 64 }  { sxx_out_ap_vld out_vld 1 1 } } }
	sxy_out { ap_vld {  { sxy_out out_data 1 64 }  { sxy_out_ap_vld out_vld 1 1 } } }
	sy_out { ap_vld {  { sy_out out_data 1 64 }  { sy_out_ap_vld out_vld 1 1 } } }

...
set C_modelArgList {
	...
	{ Sx_1_out double 64 regular {pointer 1}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "size", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "Sx_1_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ arrx_address0 sc_out sc_lv 10 signal 2 } 
	{ arrx_ce0 sc_out sc_logic 1 signal 2 } 
	{ arrx_q0 sc_in sc_lv 7 signal 2 } 
	{ Sx_1_out sc_out sc_lv 64 signal 3 } 
	{ Sx_1_out_ap_vld sc_out sc_logic 1 outvld 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "Sx_1_out", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "Sx_1_out", "role": "default" }} , 
 	{ "name": "Sx_1_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "Sx_1_out", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sitodp_64ns_64_2_no_dsp_1_U30", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "308", "Max" : "1352"}
	, {"Name" : "Interval", "Min" : "308", "Max" : "1352"}
]}
...
set Spec2ImplPortList { 
	...
	Sx_1_out { ap_vld {  { Sx_1_out out_data 1 64 }  { Sx_1_out_ap_vld out_vld 1 1 } } }
}

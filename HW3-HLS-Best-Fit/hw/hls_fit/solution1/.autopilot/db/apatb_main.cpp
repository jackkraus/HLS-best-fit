...
// wrapc file define:
#define AUTOTB_TVOUT_return "../tv/cdatafile/c.main.autotvout_ap_return.dat"
...
extern "C"
hls::sim::Byte<4> main_hw_stub_wrapper();

extern "C"
hls::sim::Byte<4> apatb_main_hw()
{
  ...
  try {
    ...
    ap_return = main_hw_stub_wrapper();

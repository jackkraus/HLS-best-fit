...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_Stt_out \
    op interface \
    ports { Stt_out { O 64 vector } Stt_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_term2_out \
    op interface \
    ports { term2_out { O 64 vector } term2_out_ap_vld { O 1 bit } } \
} "
}

...
set name fit_mul_64s_64s_64_1_1
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_sxx_out \
    op interface \
    ports { sxx_out { O 64 vector } sxx_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_sxy_out \
    op interface \
    ports { sxy_out { O 64 vector } sxy_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_sy_out \
    op interface \
    ports { sy_out { O 64 vector } sy_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_sx_out \
    op interface \
    ports { sx_out { O 64 vector } sx_out_ap_vld { O 1 bit } } \
} "
}
...
set InstName fit_flow_control_loop_pipe_sequential_init_U
set CompName fit_flow_control_loop_pipe_sequential_init
